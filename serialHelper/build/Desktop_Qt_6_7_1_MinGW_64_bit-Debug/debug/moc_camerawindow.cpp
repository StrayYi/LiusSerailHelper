...
struct qt_meta_stringdata_CLASScamerawindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASScamerawindowENDCLASS = QtMocHelpers::stringData(
    "camerawindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASScamerawindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject camerawindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASScamerawindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASScamerawindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASScamerawindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *camerawindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASScamerawindowENDCLASS.stringdata0))
